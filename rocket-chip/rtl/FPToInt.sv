...
module FPToInt(
  ...
  wire [63:0] store;	// src/main/scala/util/package.scala:39:76
  ...
  wire        store_truncIdx = in_typeTagOut[0];	// src/main/scala/tile/FPU.scala:460:21, src/main/scala/util/package.scala:38:47
  wire        classify_out_truncIdx = in_typeTagOut[0];	// src/main/scala/tile/FPU.scala:460:21, src/main/scala/util/package.scala:38:47
  assign store =
    store_truncIdx
      ? {store_unrecoded_1[63:32],
         (&classify_out_code_1) ? store_prevUnrecoded_1 : store_unrecoded_1[31:0]}
      : {2{(&classify_out_code_1) ? store_prevUnrecoded : store_unrecoded[31:0]}};	// hardfloat/hardfloat/src/main/scala/fNFromRecFN.scala:66:12, src/main/scala/tile/FPU.scala:243:56, :248:17, :440:{10,21,44,81}, :470:58, src/main/scala/util/package.scala:38:47, :39:76
  wire [63:0] io_out_bits_store_0 = store;	// src/main/scala/util/package.scala:39:76
  wire [63:0] toint;	// src/main/scala/tile/FPU.scala:471:26
  wire        intType;	// src/main/scala/tile/FPU.scala:472:28
  wire [63:0] io_out_bits_toint_0 = intType ? toint : {{32{toint[31]}}, toint[31:0]};	// src/main/scala/tile/FPU.scala:471:26, :472:28, :474:59, src/main/scala/util/package.scala:39:76, :132:{15,20,38}
  ...
  wire [11:0] classify_out_expOut_commonCase = classify_out_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:50
  ...
  wire [9:0]  classify_out =
    classify_out_truncIdx
      ...
      : {classify_out_hi_1, classify_out_lo};	// src/main/scala/tile/FPU.scala:261:8, src/main/scala/util/package.scala:38:47, :39:76
  wire        cvtType = in_typ[1];	// src/main/scala/tile/FPU.scala:460:21, src/main/scala/util/package.scala:163:13
  assign intType = in_wflags ? ~in_ren2 & cvtType : ~(in_rm[0]) & in_fmt[0];	// src/main/scala/tile/FPU.scala:460:21, :472:{28,35}, :477:{14,19}, :480:13, :483:20, :486:13, :488:{11,21}, :490:15, src/main/scala/util/package.scala:163:13
  ...
  assign toint =
    in_wflags
      ...
      : in_rm[0] ? {store[63:32], 22'h0, classify_out} : store;	// src/main/scala/tile/FPU.scala:460:21, :463:20, :471:26, :477:{14,19}, :479:{11,27,36}, :483:20, :484:{11,15,22,27,53,57,66}, :488:21, :491:24, :495:13, :500:{23,32}, :507:27, :508:54, :509:{26,34,40,53}, src/main/scala/util/package.scala:39:76, :163:13
  ...
  wire [4:0]  io_out_bits_exc_0 =
    in_wflags
      ...
      : 5'h0;	// src/main/scala/tile/FPU.scala:460:21, :463:20, :475:19, :483:20, :485:21, :488:21, :491:24, :496:{23,29,102}, :500:32, :508:54, :510:{27,33,53,62}, src/main/scala/util/package.scala:163:13
