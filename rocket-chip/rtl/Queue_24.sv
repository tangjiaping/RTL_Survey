...
module Queue_24(
  ...
  wire [3:0]   io_enq_bits_source_0 = io_enq_bits_source;
  wire [31:0]  io_enq_bits_address_0 = io_enq_bits_address;
  wire         io_enq_bits_user_amba_prot_bufferable_0 =
    io_enq_bits_user_amba_prot_bufferable;
  wire         io_enq_bits_user_amba_prot_modifiable_0 =
    io_enq_bits_user_amba_prot_modifiable;
  wire         io_enq_bits_user_amba_prot_readalloc_0 =
    io_enq_bits_user_amba_prot_readalloc;
  wire         io_enq_bits_user_amba_prot_writealloc_0 =
    io_enq_bits_user_amba_prot_writealloc;
  wire         io_enq_bits_user_amba_prot_privileged_0 =
    io_enq_bits_user_amba_prot_privileged;
  wire         io_enq_bits_user_amba_prot_secure_0 = io_enq_bits_user_amba_prot_secure;
  wire         io_enq_bits_user_amba_prot_fetch_0 = io_enq_bits_user_amba_prot_fetch;
  ...
  wire [2:0]   io_enq_bits_param = 3'h0;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  ...
  wire [3:0]   io_deq_bits_size_0 = _ram_ext_R0_data[9:6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]   io_deq_bits_source_0 = _ram_ext_R0_data[13:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0]  io_deq_bits_address_0 = _ram_ext_R0_data[45:14];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_bufferable_0 = _ram_ext_R0_data[46];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_modifiable_0 = _ram_ext_R0_data[47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_readalloc_0 = _ram_ext_R0_data[48];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_writealloc_0 = _ram_ext_R0_data[49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_privileged_0 = _ram_ext_R0_data[50];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_secure_0 = _ram_ext_R0_data[51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_user_amba_prot_fetch_0 = _ram_ext_R0_data[52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask_0 = _ram_ext_R0_data[60:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data_0 = _ram_ext_R0_data[124:61];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt_0 = _ram_ext_R0_data[125];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_2x126 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_data
      ({1'h0,
        io_enq_bits_data_0,
        io_enq_bits_mask_0,
        io_enq_bits_user_amba_prot_fetch_0,
        io_enq_bits_user_amba_prot_secure_0,
        io_enq_bits_user_amba_prot_privileged_0,
        io_enq_bits_user_amba_prot_writealloc_0,
        io_enq_bits_user_amba_prot_readalloc_0,
        io_enq_bits_user_amba_prot_modifiable_0,
        io_enq_bits_user_amba_prot_bufferable_0,
  ...
  assign io_deq_bits_user_amba_prot_bufferable = io_deq_bits_user_amba_prot_bufferable_0;
  assign io_deq_bits_user_amba_prot_modifiable = io_deq_bits_user_amba_prot_modifiable_0;
  assign io_deq_bits_user_amba_prot_readalloc = io_deq_bits_user_amba_prot_readalloc_0;
  assign io_deq_bits_user_amba_prot_writealloc = io_deq_bits_user_amba_prot_writealloc_0;
  assign io_deq_bits_user_amba_prot_privileged = io_deq_bits_user_amba_prot_privileged_0;
  assign io_deq_bits_user_amba_prot_secure = io_deq_bits_user_amba_prot_secure_0;
  assign io_deq_bits_user_amba_prot_fetch = io_deq_bits_user_amba_prot_fetch_0;
