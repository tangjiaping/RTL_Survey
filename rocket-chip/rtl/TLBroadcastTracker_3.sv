...
module TLBroadcastTracker_3(
  ...
  output        io_idle,	// src/main/scala/tilelink/Broadcast.scala:401:14
                ...
                io_cacheOH,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  wire        io_probe_bits_count_0 = io_probe_bits_count;
  ...
  wire        io_clearOH_0 = io_clearOH;
  wire        io_probe_bits_cacheOH = 1'h1;
  ...
  wire [7:0]  i_data_bits_mask = io_in_a_bits_mask_0;	// src/main/scala/tilelink/Broadcast.scala:483:20
  wire [63:0] i_data_bits_data = io_in_a_bits_data_0;	// src/main/scala/tilelink/Broadcast.scala:483:20
  ...
  wire        io_cacheOH_0 = cacheOH;	// src/main/scala/tilelink/Broadcast.scala:435:20
  ...
  wire        _GEN = io_in_a_ready_0 & io_in_a_valid_0 & io_in_a_first_0;	// src/main/scala/tilelink/Broadcast.scala:438:22
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      got_e <=
        io_e_last_0
        | (_GEN ? io_in_a_bits_opcode_0 != 3'h6 & io_in_a_bits_opcode_0 != 3'h7 : got_e);	// src/main/scala/tilelink/Broadcast.scala:424:24, :438:{22,40}, :442:{13,36,64,87}, :463:20, :465:11
      sent_d <= io_d_last_0 | ~_GEN & sent_d;	// src/main/scala/tilelink/Broadcast.scala:425:24, :438:{22,40}, :440:13, :459:20, :461:12
    ...
    shared <= io_probesack_0 | ~_GEN & shared;	// src/main/scala/tilelink/Broadcast.scala:425:24, :426:20, :438:{22,40}, :440:13, :441:13, :473:23, :474:12
    ...
    if (_GEN_0)	// src/main/scala/tilelink/Broadcast.scala:468:22
      count <= count - ~(io_probenack_0 & io_probedack_0);	// src/main/scala/tilelink/Broadcast.scala:434:20, :470:{20,25,39}
    ...
    cacheOH <= io_probe_valid_0 | cacheOH & ~io_clearOH_0;	// src/main/scala/tilelink/Broadcast.scala:435:20, :453:{11,22,24}, :454:25, :456:13
  end // always @(posedge)
  ...
  Queue_77 o_data_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
