...
module BreakpointUnit(
  ...
  input  [38:0] io_pc,	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire [38:0] _w_T_5 = ~io_ea_0;	// src/main/scala/rocket/Breakpoint.scala:62:6
  ...
  wire [1:0]  r_lo = {_r_T_8, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  r_hi = {_r_T_10 & io_bp_0_address_0[2], _r_T_10};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  wire [38:0] _x_T_15 = ~io_bp_0_address_0;	// src/main/scala/rocket/Breakpoint.scala:62:24
  ...
  wire [1:0]  r_lo_1 = {_r_T_18, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  r_hi_1 = {_r_T_20 & io_bp_0_address_0[2], _r_T_20};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  assign r =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[38:4],
            _w_T_5[3:0]
              | {r_hi, r_lo}} == {_x_T_15[38:4], _x_T_15[3:0] | {r_hi_1, r_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :106:{32,58}, src/main/scala/util/package.scala:45:27
  ...
  wire [1:0]  w_lo = {_w_T_8, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  w_hi = {_w_T_10 & io_bp_0_address_0[2], _w_T_10};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  ...
  wire [1:0]  w_lo_1 = {_w_T_18, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  w_hi_1 = {_w_T_20 & io_bp_0_address_0[2], _w_T_20};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  assign w =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[38:4],
            _w_T_5[3:0]
              | {w_hi, w_lo}} == {_x_T_15[38:4], _x_T_15[3:0] | {w_hi_1, w_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :107:{32,58}, src/main/scala/util/package.scala:45:27
  wire        io_bpwatch_0_wvalid_0_0 = w;	// src/main/scala/rocket/Breakpoint.scala:107:58
  wire [38:0] _x_T_5 = ~io_pc_0;	// src/main/scala/rocket/Breakpoint.scala:62:6
  ...
  wire [1:0]  x_lo = {_x_T_8, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  x_hi = {_x_T_10 & io_bp_0_address_0[2], _x_T_10};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  ...
  wire [1:0]  x_lo_1 = {_x_T_18, io_bp_0_control_tmatch_0[0]};	// src/main/scala/rocket/Breakpoint.scala:59:73, :65:36, src/main/scala/util/package.scala:45:27
  wire [1:0]  x_hi_1 = {_x_T_20 & io_bp_0_address_0[2], _x_T_20};	// src/main/scala/rocket/Breakpoint.scala:59:{73,83}, src/main/scala/util/package.scala:45:27
  assign x =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_x_T_5[38:4],
            _x_T_5[3:0]
              | {x_hi, x_lo}} == {_x_T_15[38:4], _x_T_15[3:0] | {x_hi_1, x_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :108:{32,58}, src/main/scala/util/package.scala:45:27
