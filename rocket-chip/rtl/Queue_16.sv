...
module Queue_16(
  ...
  wire [1:0]  io_enq_bits_resp_0 = io_enq_bits_resp;
  ...
  wire [63:0] io_deq_bits_data_0 = _ram_ext_R0_data[67:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_resp_0 = _ram_ext_R0_data[69:68];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_echo_tl_state_size_0 = _ram_ext_R0_data[73:70];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [4:0]  io_deq_bits_echo_tl_state_source_0 = _ram_ext_R0_data[78:74];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_last_0 = _ram_ext_R0_data[79];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire        io_deq_valid;
  wire        do_deq = io_deq_ready_0 & io_deq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, :282:27
  ...
  wire [3:0]  io_count = {full, ptr_diff};	// src/main/scala/chisel3/util/Decoupled.scala:280:24, :327:32, :330:62
  ...
  assign io_deq_bits_resp = io_deq_bits_resp_0;
