...
module RoundAnyRawFNToRecFN_6(
  ...
  wire [54:0] roundedSig =
    roundIncr
      ...
      : {1'h0, adjustedSig[55:2] & ~(roundMask[55:2])}
        | (roundingMode_odd & anyRound ? roundPosMask[55:1] : 55'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:89:53, :94:53, :113:22, :158:42, :162:46, :163:56, :164:62, :165:36, :169:31, :172:16, :173:{32,49,57}, :174:{21,25,64}, :175:30, :176:35, :179:{30,32,43,47}, :180:{24,42,67}
  ...
  wire [11:0] expOut =
    ...
    | (isNaNOut ? 12'hE00 : 12'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:121:31, :124:37, :234:34, :244:45, :245:39, :247:32, :252:{14,18,32}, :256:{14,18}, :260:{14,18}, :263:17, :264:{14,18}, :268:16, :272:16, :276:{16,73}, :277:16
  wire [51:0] fractOut =
    (isNaNOut | io_in_isZero_0 | common_totalUnderflow
       ? {isNaNOut, 51'h0}
       : common_fractOut) | {52{pegMaxFiniteMagOut}};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:122:31, :124:37, :234:34, :245:39, :279:{12,38}, :280:16, :282:11, :283:13
