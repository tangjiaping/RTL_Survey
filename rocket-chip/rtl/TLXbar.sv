...
module TLXbar(
  ...
  wire        auto_out_1_a_bits_user_amba_prot_bufferable = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_modifiable = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_readalloc = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_writealloc = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_privileged = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_secure = 1'h0;
  wire        auto_out_1_a_bits_user_amba_prot_fetch = 1'h0;
  wire        auto_out_1_b_bits_corrupt = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_bufferable = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_modifiable = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_readalloc = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_writealloc = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_privileged = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_secure = 1'h0;
  wire        auto_out_1_c_bits_user_amba_prot_fetch = 1'h0;
