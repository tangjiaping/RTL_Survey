...
module TLFragmenter_2(
  ...
  wire [11:0] auto_in_a_bits_address_0 = auto_in_a_bits_address;
  ...
  wire [11:0] nodeIn_a_bits_address = auto_in_a_bits_address_0;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [11:0] nodeOut_a_bits_address;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [11:0] auto_out_a_bits_address_0 = nodeOut_a_bits_address;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire        dLast = dFragnum == 3'h0;	// src/main/scala/tilelink/Fragmenter.scala:194:41, :196:30
  ...
  wire [2:0]  aMask = aHasData ? 3'h0 : aFragOH1;	// src/main/scala/tilelink/Edges.scala:93:28, src/main/scala/tilelink/Fragmenter.scala:291:24, src/main/scala/util/package.scala:243:46
  reg  [2:0]  gennum;	// src/main/scala/tilelink/Fragmenter.scala:293:29
  wire        aFirst = gennum == 3'h0;	// src/main/scala/tilelink/Fragmenter.scala:293:29, :294:29
  ...
  wire        aLast = aFragnum == 3'h0;	// src/main/scala/tilelink/Fragmenter.scala:297:24, :298:30
  ...
  assign nodeOut_a_bits_address =
    {_repeater_io_deq_bits_address[11:6],
     _repeater_io_deq_bits_address[5:0] | {~(old_gennum1 | ~(aOrigOH1[5:3])), 3'h0}};	// src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Fragmenter.scala:264:30, :295:30, :306:{49,51,88,90,111}, src/main/scala/util/package.scala:243:46
  ...
  `endif // not def SYNTHESIS
  assign nodeOut_a_bits_mask = _repeater_io_full ? 8'hFF : nodeIn_a_bits_mask;	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Fragmenter.scala:264:30, :315:31
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      gennum <= 3'h0;	// src/main/scala/tilelink/Fragmenter.scala:293:29
    end
    else begin
      if (_GEN_0) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
        if (dFirst)	// src/main/scala/tilelink/Fragmenter.scala:195:29
          ...
          acknum <= acknum - {2'h0, ack_decrement};	// src/main/scala/tilelink/Fragmenter.scala:191:29, :206:32, :211:55
      end
