...
module Queue_102(
  ...
  wire [3:0]  io_deq_bits_id_0 = empty ? io_enq_bits_id_0 : ram[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [30:0] io_deq_bits_addr_0 = empty ? io_enq_bits_addr_0 : ram[34:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [7:0]  io_deq_bits_len_0 = empty ? io_enq_bits_len_0 : ram[42:35];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [2:0]  io_deq_bits_size_0 = empty ? io_enq_bits_size_0 : ram[45:43];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [1:0]  io_deq_bits_burst_0 = empty ? io_enq_bits_burst_0 : ram[47:46];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire        io_deq_bits_lock_0 = empty ? io_enq_bits_lock_0 : ram[48];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [3:0]  io_deq_bits_cache_0 = empty ? io_enq_bits_cache_0 : ram[52:49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [2:0]  io_deq_bits_prot_0 = empty ? io_enq_bits_prot_0 : ram[55:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [3:0]  io_deq_bits_qos_0 = empty ? io_enq_bits_qos_0 : ram[59:56];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
