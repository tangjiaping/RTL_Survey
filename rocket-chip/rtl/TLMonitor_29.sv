...
module TLMonitor_29(
  ...
  wire [6:0]  io_in_a_bits_address_0 = io_in_a_bits_address;
  ...
  wire [1:0]  io_in_d_bits_size = 2'h2;
  ...
  wire [3:0]  a_size_lookup = {1'h0, inflight_sizes[3:1]};	// src/main/scala/tilelink/Monitor.scala:615:33, :636:33, :638:{19,144}
  ...
  wire        _GEN = io_in_d_bits_opcode_0 == 3'h6;	// src/main/scala/tilelink/Monitor.scala:670:46
  ...
  wire [3:0]  c_size_lookup = {1'h0, inflight_sizes_1[3:1]};	// src/main/scala/tilelink/Monitor.scala:725:35, :745:35, :747:{21,146}
  ...
  `ifndef SYNTHESIS	// src/main/scala/tilelink/Monitor.scala:42:11
    always @(posedge clock) begin	// src/main/scala/tilelink/Monitor.scala:42:11
      ...
      automatic logic            _GEN_7 =
        {io_in_a_bits_address_0[6:4] ^ 3'h4, io_in_a_bits_address_0[2]} == 4'h0
        | io_in_a_bits_address_0[6:3] == 4'hA;	// src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, src/main/scala/tilelink/Parameters.scala:672:42
      ...
      automatic logic            _GEN_14 = io_in_a_valid_0 & ~a_first & ~reset;	// src/main/scala/tilelink/Edges.scala:232:25, src/main/scala/tilelink/Monitor.scala:42:11, :389:22
      ...
      if (io_in_d_valid_0 & io_in_d_bits_opcode_0 == 3'h4 & ~reset) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :49:11, :318:25
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (io_in_d_valid_0 & io_in_d_bits_opcode_0 == 3'h5 & ~reset) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :49:11, :328:25
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (_GEN_14 & io_in_a_bits_opcode_0 != opcode) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :384:22, :390:32
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:42:11
      ...
      if (_GEN_14 & io_in_a_bits_address_0 != address) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :388:22, :394:32
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:42:11
      ...
      if (io_in_d_valid_0 & ~d_first & ~reset & io_in_d_bits_opcode_0 != opcode_1) begin	// src/main/scala/tilelink/Edges.scala:232:25, src/main/scala/tilelink/Monitor.scala:42:11, :49:11, :535:22, :541:22, :542:29
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (d_clr_wo_ready & same_cycle_resp & ~reset
          & ~(io_in_d_bits_opcode_0 == _GEN_4[io_in_a_bits_opcode_0]
              | io_in_d_bits_opcode_0 == _GEN_3[io_in_a_bits_opcode_0])) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :49:11, :662:34, :681:88, :685:{38,77}, :686:39
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (_GEN_15
          & ~(io_in_d_bits_opcode_0 == _GEN_4[a_opcode_lookup[2:0]]
              | io_in_d_bits_opcode_0 == _GEN_3[a_opcode_lookup[2:0]])) begin	// src/main/scala/tilelink/Monitor.scala:49:11, :632:35, :689:{38,72}, :690:38
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at src/main/scala/devices/debug/Debug.scala:700:19)\n    at Monitor.scala:49 assert(cond, message)\n");	// src/main/scala/tilelink/Monitor.scala:49:11
        if (`STOP_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
          $fatal;	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (_GEN_16 & c_size_lookup != 4'h2) begin	// src/main/scala/tilelink/Monitor.scala:49:11, :745:35, :797:36
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at src/main/scala/devices/debug/Debug.scala:700:19)\n    at Monitor.scala:49 assert(cond, message)\n");	// src/main/scala/tilelink/Monitor.scala:49:11
        if (`STOP_COND_)	// src/main/scala/tilelink/Monitor.scala:49:11
          $fatal;	// src/main/scala/tilelink/Monitor.scala:49:11
      ...
      if (~reset
          & ~(~inflight_1 | _plusarg_reader_1_out == 32'h0
              | watchdog_1 < _plusarg_reader_1_out)) begin	// src/main/scala/tilelink/Monitor.scala:42:11, :49:11, :723:35, :815:27, :818:{39,47,59}, src/main/scala/util/PlusArg.scala:80:11
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/tilelink/Monitor.scala:42:11
          $error("Assertion failed: TileLink timeout expired (connected at src/main/scala/devices/debug/Debug.scala:700:19)\n    at Monitor.scala:42 assert(cond, message)\n");	// src/main/scala/tilelink/Monitor.scala:42:11
        if (`STOP_COND_)	// src/main/scala/tilelink/Monitor.scala:42:11
          $fatal;	// src/main/scala/tilelink/Monitor.scala:42:11
