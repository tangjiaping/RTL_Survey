...
module Queue_54(
  ...
  wire [6:0]  io_enq_bits_tl_state_source_0 = io_enq_bits_tl_state_source;
  wire [2:0]  io_enq_bits_extra_id_0 = io_enq_bits_extra_id;
  wire        io_deq_ready_0 = io_deq_ready;
  wire [3:0]  io_deq_bits_tl_state_size_0 = _ram_ext_R0_data[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [6:0]  io_deq_bits_tl_state_source_0 = _ram_ext_R0_data[10:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_extra_id_0 = _ram_ext_R0_data[13:11];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_8x14 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_enq_bits_extra_id_0,
        io_enq_bits_tl_state_source_0,
        io_enq_bits_tl_state_size_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
  ...
  assign io_deq_bits_extra_id = io_deq_bits_extra_id_0;
endmodule
