...
module MulAddRecFNToRaw_postMul(
  ...
  wire [49:0]  CDom_absSigSum =
    io_fromPreMul_doSubMags_0
      ? ~(sigSum[74:25])
      : {1'h0, io_fromPreMul_highAlignedSigC_0[25:24], sigSum[72:26]};	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:190:12, :203:12, :204:{13,20}, :207:{46,71}, :208:23
  wire         CDom_absSigSumExtra =
    io_fromPreMul_doSubMags_0 ? sigSum[24:1] != 24'hFFFFFF : (|(sigSum[25:1]));	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:190:12, :212:12, :213:{21,36}, :214:{19,37}
  ...
  wire [5:0]   notCDom_nearNormDist = {notCDom_normDistReduced2, 1'h0};	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:238:56, src/main/scala/chisel3/util/Mux.scala:50:70
  wire [9:0]   notCDom_sExp = io_fromPreMul_sExpSum_0 - {4'h0, notCDom_nearNormDist};	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:238:56, :239:46
