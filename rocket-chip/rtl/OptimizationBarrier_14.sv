...
module OptimizationBarrier_14(
  ...
  wire        io_y_u = io_x_u_0;
  wire        io_y_g = io_x_g_0;
  wire        io_y_ae_ptw = io_x_ae_ptw_0;
  wire        io_y_ae_final = io_x_ae_final_0;
  wire        io_y_ae_stage2 = io_x_ae_stage2_0;
  wire        io_y_pf = io_x_pf_0;
  wire        io_y_gf = io_x_gf_0;
  wire        io_y_sw = io_x_sw_0;
  wire        io_y_sx = io_x_sx_0;
  wire        io_y_sr = io_x_sr_0;
  wire        io_y_hw = io_x_hw_0;
  wire        io_y_hx = io_x_hx_0;
  wire        io_y_hr = io_x_hr_0;
  wire        io_y_pw = io_x_pw_0;
  wire        io_y_px = io_x_px_0;
  wire        io_y_pr = io_x_pr_0;
  wire        io_y_ppp = io_x_ppp_0;
  wire        io_y_pal = io_x_pal_0;
  wire        io_y_paa = io_x_paa_0;
  wire        io_y_eff = io_x_eff_0;
  wire        io_y_c = io_x_c_0;
