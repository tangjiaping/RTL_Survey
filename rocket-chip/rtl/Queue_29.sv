...
module Queue_29(
  ...
  wire [6:0] io_enq_bits_extra_id_0 = io_enq_bits_extra_id;
  wire       io_enq_bits_real_last_0 = io_enq_bits_real_last;
  wire       io_deq_ready_0 = io_deq_ready;
  wire [6:0] io_deq_bits_extra_id_0 = _ram_ext_R0_data[6:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire       io_deq_bits_real_last_0 = _ram_ext_R0_data[7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [2:0] io_count = {full, ptr_diff};	// src/main/scala/chisel3/util/Decoupled.scala:280:24, :327:32, :330:62
  ...
  ram_4x8 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_real_last_0, io_enq_bits_extra_id_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
  assign io_enq_ready = io_enq_ready_0;
  assign io_deq_valid = io_deq_valid_0;
  assign io_deq_bits_extra_id = io_deq_bits_extra_id_0;
  assign io_deq_bits_real_last = io_deq_bits_real_last_0;
endmodule
