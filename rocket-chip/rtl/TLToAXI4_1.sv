...
module TLToAXI4_1(
  ...
  wire [2:0]        beats1 = beats1_opdata ? beats1_decode : 3'h0;	// src/main/scala/tilelink/Edges.scala:93:28, :221:59, :222:14
  ...
  wire              a_first = counter == 3'h0;	// src/main/scala/tilelink/Edges.scala:230:27, :232:25
  wire              a_last = counter == 3'h1 | beats1 == 3'h0;	// src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}
  ...
  wire [2:0]        out_arw_bits_size =
    nodeIn_a_bits_size > 3'h2 ? 3'h3 : nodeIn_a_bits_size;	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/ToAXI4.scala:146:25, :168:{23,31}
  ...
  Queue_72 nodeOut_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
