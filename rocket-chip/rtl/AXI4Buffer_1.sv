...
module AXI4Buffer_1(
  ...
  Queue_87 nodeOut_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_89 nodeOut_ar_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
