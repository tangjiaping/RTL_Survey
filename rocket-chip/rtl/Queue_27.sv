...
module Queue_27(
  ...
  wire [1:0] io_deq_bits_resp_0 = empty ? io_enq_bits_resp_0 : ram[2:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {io_enq_bits_resp_0, io_enq_bits_id_0};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
