...
module Queue_37(
  ...
  wire [13:0]  io_enq_bits_address_0 = io_enq_bits_address;
  ...
  wire [2:0]   io_deq_bits_opcode_0 = ram[2:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]   io_deq_bits_param = ram[5:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]   io_deq_bits_size_0 = ram[9:6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [4:0]   io_deq_bits_source_0 = ram[14:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [13:0]  io_deq_bits_address = ram[28:15];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask = ram[36:29];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data = ram[100:37];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt = ram[101];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
