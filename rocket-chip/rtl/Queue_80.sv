...
module Queue_80(
  ...
  wire [63:0]  io_enq_bits_data = 64'h0;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  wire [7:0]   io_enq_bits_mask = 8'hFF;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  wire [1:0]   io_enq_bits_source = 2'h0;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  wire [3:0]   io_enq_bits_size = 4'h6;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  wire [2:0]   io_enq_bits_opcode = 3'h6;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  ...
  wire [1:0]   io_deq_bits_source_0 = _ram_ext_R0_data[10:9];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0]  io_deq_bits_address_0 = _ram_ext_R0_data[42:11];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask_0 = _ram_ext_R0_data[50:43];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data_0 = _ram_ext_R0_data[114:51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt_0 = _ram_ext_R0_data[115];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_2x116 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({73'hFF, io_enq_bits_address_0, 6'h6, io_enq_bits_param_0, 3'h6})	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  );
