...
module tag_array_64x84(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [5:0]  RW0_addr,
  input         RW0_en,
                RW0_clk,
                RW0_wmode,
  ...
  reg [83:0] Memory[0:63];	// src/main/scala/util/DescribedSRAM.scala:17:26
    ...
    initial begin	// src/main/scala/util/DescribedSRAM.scala:17:26
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[83:0];	// src/main/scala/util/DescribedSRAM.scala:17:26
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
