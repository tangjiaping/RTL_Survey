...
module Queue_97(
  ...
  wire [63:0] io_deq_bits_data_0 = _ram_ext_R0_data[63:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_strb_0 = _ram_ext_R0_data[71:64];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_last_0 = _ram_ext_R0_data[72];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_2x73 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last_0, io_enq_bits_strb_0, io_enq_bits_data_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
