...
module Queue_83(
  ...
  wire         io_enq_bits_read_0 = io_enq_bits_read;
  wire [22:0]  io_enq_bits_index_0 = io_enq_bits_index;
  ...
  wire [1:0]   io_enq_bits_extra_tlrr_extra_size_0 = io_enq_bits_extra_tlrr_extra_size;
  ...
  wire         io_deq_bits_read_0 = ram[0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [22:0]  io_deq_bits_index_0 = ram[23:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data_0 = ram[87:24];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask_0 = ram[95:88];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]   io_deq_bits_extra_tlrr_extra_source_0 = ram[104:96];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]   io_deq_bits_extra_tlrr_extra_size_0 = ram[106:105];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <=
        {io_enq_bits_extra_tlrr_extra_size_0,
         ...
         io_enq_bits_data_0,
         io_enq_bits_index_0,
         io_enq_bits_read_0};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
  ...
  assign io_deq_bits_read = io_deq_bits_read_0;
  assign io_deq_bits_index = io_deq_bits_index_0;
  assign io_deq_bits_data = io_deq_bits_data_0;
  assign io_deq_bits_mask = io_deq_bits_mask_0;
  assign io_deq_bits_extra_tlrr_extra_source = io_deq_bits_extra_tlrr_extra_source_0;
  assign io_deq_bits_extra_tlrr_extra_size = io_deq_bits_extra_tlrr_extra_size_0;
endmodule
