...
module Queue_73(
  ...
  wire [6:0]  io_enq_bits_id_0 = io_enq_bits_id;
  ...
  wire [6:0]  io_enq_bits_echo_tl_state_source_0 = io_enq_bits_echo_tl_state_source;
  ...
  wire [6:0]  io_deq_bits_id_0 = ram[6:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0] io_deq_bits_addr_0 = ram[38:7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_len_0 = ram[46:39];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_size_0 = ram[49:47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_burst_0 = ram[51:50];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_lock_0 = ram[52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_cache_0 = ram[56:53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_prot_0 = ram[59:57];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_qos_0 = ram[63:60];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_echo_tl_state_size_0 = ram[67:64];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [6:0]  io_deq_bits_echo_tl_state_source_0 = ram[74:68];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_wen_0 = ram[75];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
