...
module Queue_88(
  ...
  wire [1:0] io_deq_bits_resp_0 = _ram_ext_R0_data[5:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire       io_deq_bits_echo_real_last_0 = _ram_ext_R0_data[6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_2x7 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_echo_real_last_0, io_enq_bits_resp_0, io_enq_bits_id_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
