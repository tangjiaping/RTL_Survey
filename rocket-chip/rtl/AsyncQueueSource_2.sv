...
module AsyncQueueSource_2(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_22 ridx_ridx_gray (	// src/main/scala/util/ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_ridx_0),
    .io_q  (ridx)
  );
  AsyncValidSync_16 source_valid_0 (	// src/main/scala/util/AsyncQueue.scala:100:32
    .io_out (_source_valid_0_io_out),
    .clock  (clock),
    .reset  (reset | ~io_async_safe_sink_reset_n_0)	// src/main/scala/util/AsyncQueue.scala:105:{43,46}
  );
  AsyncValidSync_17 source_valid_1 (	// src/main/scala/util/AsyncQueue.scala:101:32
  ...
  AsyncValidSync_18 sink_extend (	// src/main/scala/util/AsyncQueue.scala:103:30
  ...
  AsyncValidSync_19 sink_valid (	// src/main/scala/util/AsyncQueue.scala:104:30
