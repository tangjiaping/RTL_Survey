...
module TilePRCIDomain(
  ...
  output        auto_int_out_clock_xing_out_1_sync_0,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  input         auto_int_in_clock_xing_in_2_sync_0,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire [39:0] tile_reset_domain_auto_tile_broadcast_out_insns_0_tval;
  ...
  wire [39:0] tile_reset_domain_auto_tile_broadcast_out_insns_0_iaddr;
  ...
  wire        auto_int_in_clock_xing_in_2_sync_0_0 = auto_int_in_clock_xing_in_2_sync_0;
  ...
  wire        auto_int_out_clock_xing_out_2_sync_0 = 1'h0;
  wire        auto_int_out_clock_xing_out_0_sync_0 = 1'h0;
  ...
  wire        auto_tl_master_clock_xing_out_e_ready = 1'h1;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Buffer.scala:69:28
  ...
  wire [1:0]  auto_tl_master_clock_xing_out_b_bits_source = 2'h0;	// src/main/scala/diplomacy/LazyModule.scala:374:18, src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Buffer.scala:69:28
  ...
  wire        intInClockXingIn_2_sync_0 = auto_int_in_clock_xing_in_2_sync_0_0;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [39:0] trace_auto_in_insns_0_iaddr =
  ...
  wire [39:0] trace_auto_in_insns_0_tval =
  ...
  wire [39:0] trace_nodeIn_insns_0_iaddr = trace_auto_in_insns_0_iaddr;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [39:0] trace_nodeIn_insns_0_tval = trace_auto_in_insns_0_tval;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  RocketTile tile_reset_domain_tile (	// src/main/scala/subsystem/HasTiles.scala:251:53
    ...
    .auto_int_local_in_3_0                (tile_reset_domain_auto_tile_int_local_in_3_0),
  ...
  TLBuffer_10 buffer (	// src/main/scala/tilelink/Buffer.scala:69:28
    ...
    .auto_in_a_ready         (tile_reset_domain_auto_tile_buffer_out_a_ready),
    .auto_in_a_valid         (tile_reset_domain_auto_tile_buffer_out_a_valid),
    .auto_in_a_bits_opcode   (tile_reset_domain_auto_tile_buffer_out_a_bits_opcode),
    .auto_in_a_bits_param    (tile_reset_domain_auto_tile_buffer_out_a_bits_param),
    .auto_in_a_bits_size     (tile_reset_domain_auto_tile_buffer_out_a_bits_size),
    .auto_in_a_bits_source   (tile_reset_domain_auto_tile_buffer_out_a_bits_source),
    .auto_in_a_bits_address  (tile_reset_domain_auto_tile_buffer_out_a_bits_address),
    .auto_in_a_bits_mask     (tile_reset_domain_auto_tile_buffer_out_a_bits_mask),
    .auto_in_a_bits_data     (tile_reset_domain_auto_tile_buffer_out_a_bits_data),
    .auto_in_b_ready         (tile_reset_domain_auto_tile_buffer_out_b_ready),
    .auto_in_b_valid         (tile_reset_domain_auto_tile_buffer_out_b_valid),
    .auto_in_b_bits_opcode   (tile_reset_domain_auto_tile_buffer_out_b_bits_opcode),
    .auto_in_b_bits_param    (tile_reset_domain_auto_tile_buffer_out_b_bits_param),
    .auto_in_b_bits_size     (tile_reset_domain_auto_tile_buffer_out_b_bits_size),
    .auto_in_b_bits_source   (tile_reset_domain_auto_tile_buffer_out_b_bits_source),
    .auto_in_b_bits_address  (tile_reset_domain_auto_tile_buffer_out_b_bits_address),
    .auto_in_b_bits_mask     (tile_reset_domain_auto_tile_buffer_out_b_bits_mask),
    .auto_in_b_bits_data     (tile_reset_domain_auto_tile_buffer_out_b_bits_data),
    .auto_in_b_bits_corrupt  (tile_reset_domain_auto_tile_buffer_out_b_bits_corrupt),
    .auto_in_c_ready         (tile_reset_domain_auto_tile_buffer_out_c_ready),
    .auto_in_c_valid         (tile_reset_domain_auto_tile_buffer_out_c_valid),
    .auto_in_c_bits_opcode   (tile_reset_domain_auto_tile_buffer_out_c_bits_opcode),
    .auto_in_c_bits_param    (tile_reset_domain_auto_tile_buffer_out_c_bits_param),
    .auto_in_c_bits_size     (tile_reset_domain_auto_tile_buffer_out_c_bits_size),
    .auto_in_c_bits_source   (tile_reset_domain_auto_tile_buffer_out_c_bits_source),
    .auto_in_c_bits_address  (tile_reset_domain_auto_tile_buffer_out_c_bits_address),
    .auto_in_c_bits_data     (tile_reset_domain_auto_tile_buffer_out_c_bits_data),
    .auto_in_d_ready         (tile_reset_domain_auto_tile_buffer_out_d_ready),
    .auto_in_d_valid         (tile_reset_domain_auto_tile_buffer_out_d_valid),
    .auto_in_d_bits_opcode   (tile_reset_domain_auto_tile_buffer_out_d_bits_opcode),
    .auto_in_d_bits_param    (tile_reset_domain_auto_tile_buffer_out_d_bits_param),
    .auto_in_d_bits_size     (tile_reset_domain_auto_tile_buffer_out_d_bits_size),
    .auto_in_d_bits_source   (tile_reset_domain_auto_tile_buffer_out_d_bits_source),
    .auto_in_d_bits_sink     (tile_reset_domain_auto_tile_buffer_out_d_bits_sink),
    .auto_in_d_bits_denied   (tile_reset_domain_auto_tile_buffer_out_d_bits_denied),
    .auto_in_d_bits_data     (tile_reset_domain_auto_tile_buffer_out_d_bits_data),
    .auto_in_d_bits_corrupt  (tile_reset_domain_auto_tile_buffer_out_d_bits_corrupt),
    .auto_in_e_ready         (tile_reset_domain_auto_tile_buffer_out_e_ready),
    .auto_in_e_valid         (tile_reset_domain_auto_tile_buffer_out_e_valid),
    .auto_in_e_bits_sink     (tile_reset_domain_auto_tile_buffer_out_e_bits_sink),
  ...
  IntSyncSyncCrossingSink_2 intsink_3 (	// src/main/scala/interrupts/Crossing.scala:99:29
    ...
    .auto_out_0     (tile_reset_domain_auto_tile_int_local_in_3_0)
  );
  ...
  IntSyncCrossingSource_3 intsource_3 ();	// src/main/scala/interrupts/Crossing.scala:28:31
