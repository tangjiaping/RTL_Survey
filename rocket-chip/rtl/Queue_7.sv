...
module Queue_7(
  ...
  wire [4:0] io_enq_bits_tl_state_source_0 = io_enq_bits_tl_state_source;
  ...
  wire [4:0] io_deq_bits_tl_state_source_0 = _ram_ext_R0_data[8:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_8x9 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_tl_state_source_0, io_enq_bits_tl_state_size_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
