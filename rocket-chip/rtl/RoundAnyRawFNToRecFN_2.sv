...
module RoundAnyRawFNToRecFN_2(
  ...
  wire [55:0] roundMask = 56'h3;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:152:55
  wire [55:0] shiftedRoundMask = 56'h1;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:161:53
  wire [55:0] roundPosMask = 56'h2;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:162:46
  ...
  wire [12:0] sAdjustedExp = {1'h0, {{3{io_in_sExp_0[8]}}, io_in_sExp_0} + 12'h780};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:103:25, :105:31
  wire [55:0] adjustedSig = {io_in_sig_0[64:10], |(io_in_sig_0[9:0])};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:115:{23,66}, :116:{26,60}
  ...
  wire [54:0] roundedSig =
    roundIncr
      ...
      : {1'h0, adjustedSig[55:3], adjustedSig[2] | roundingMode_odd & anyRound};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:89:53, :94:53, :115:66, :163:56, :164:62, :165:36, :169:31, :172:16, :173:{49,57}, :174:{21,25,64}, :175:30, :176:35, :179:47, :180:{42,67}
  wire [13:0] sRoundedExp = {sAdjustedExp[12], sAdjustedExp} + {12'h0, roundedSig[54:53]};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:105:31, :172:16, :184:{40,54}
  ...
  wire [51:0] common_fractOut = roundedSig[51:0];	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:122:31, :172:16, :190:27
  ...
  wire        roundCarry = roundedSig[53];	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:172:16, :210:16, :212:27
  ...
  wire [11:0] expOut = common_expOut & ~(io_in_isZero_0 ? 12'hE00 : 12'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:121:31, :251:24, :252:{14,18}, :276:73
  wire [51:0] fractOut = io_in_isZero_0 ? 52'h0 : common_fractOut;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:122:31, :279:12, :280:16, :282:11, :283:13
