...
module Queue_26(
  ...
  wire [63:0] io_deq_bits_data_0 = empty ? io_enq_bits_data_0 : ram[64:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [1:0]  io_deq_bits_resp_0 = empty ? io_enq_bits_resp_0 : ram[66:65];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire        io_deq_bits_last_0 = empty ? io_enq_bits_last_0 : ram[67];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <=
        {io_enq_bits_last_0, io_enq_bits_resp_0, io_enq_bits_data_0, io_enq_bits_id_0};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
