...
module Queue_75(
  ...
  wire [7:0]  io_deq_bits_mask_0 = _ram_ext_R0_data[7:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0] io_deq_bits_data_0 = _ram_ext_R0_data[71:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_8x72 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data_0, io_enq_bits_mask_0})	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  );
