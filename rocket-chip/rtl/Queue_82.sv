...
module Queue_82(
  ...
  wire [1:0] io_deq_bits_sink_0;
  wire       io_deq_valid_0;
  wire       io_enq_valid_0 = io_enq_valid;
  wire [1:0] io_enq_bits_sink_0 = io_enq_bits_sink;
  wire       io_deq_ready = 1'h1;
  wire       do_deq = io_deq_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:282:27
