...
module MulAddRecFNPipe(
  ...
  input  [32:0] io_a,	// src/main/scala/tile/FPU.scala:630:16
  ...
  output [32:0] io_out,	// src/main/scala/tile/FPU.scala:630:16
  ...
  wire [9:0]  _mulAddRecFNToRaw_postMul_io_rawOut_sExp;	// src/main/scala/tile/FPU.scala:647:42
  wire [26:0] _mulAddRecFNToRaw_postMul_io_rawOut_sig;	// src/main/scala/tile/FPU.scala:647:42
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddA;	// src/main/scala/tile/FPU.scala:646:41
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddB;	// src/main/scala/tile/FPU.scala:646:41
  wire [47:0] _mulAddRecFNToRaw_preMul_io_mulAddC;	// src/main/scala/tile/FPU.scala:646:41
  ...
  wire [9:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum;	// src/main/scala/tile/FPU.scala:646:41
  ...
  wire [4:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist;	// src/main/scala/tile/FPU.scala:646:41
  wire [25:0] _mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC;	// src/main/scala/tile/FPU.scala:646:41
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_v = _RANDOM[3'h0][0];	// src/main/scala/chisel3/util/Valid.scala:129:24
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isSigNaNAny = _RANDOM[3'h0][1];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isNaNAOrB = _RANDOM[3'h0][2];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfA = _RANDOM[3'h0][3];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroA = _RANDOM[3'h0][4];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfB = _RANDOM[3'h0][5];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroB = _RANDOM[3'h0][6];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_signProd = _RANDOM[3'h0][7];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isNaNC = _RANDOM[3'h0][8];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfC = _RANDOM[3'h0][9];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroC = _RANDOM[3'h0][10];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_sExpSum = _RANDOM[3'h0][20:11];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_doSubMags = _RANDOM[3'h0][21];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_CIsDominant = _RANDOM[3'h0][22];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_CDom_CAlignDist =
          _RANDOM[3'h0][27:23];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_highAlignedSigC =
          {_RANDOM[3'h0][31:28], _RANDOM[3'h1][21:0]};	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        ...
        mulAddRecFNToRaw_postMul_io_mulAddResult_pipe_v = _RANDOM[3'h1][23];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_mulAddResult_pipe_b =
          {_RANDOM[3'h1][31:24], _RANDOM[3'h2], _RANDOM[3'h3][8:0]};	// src/main/scala/chisel3/util/Valid.scala:130:26
        mulAddRecFNToRaw_postMul_io_roundingMode_pipe_v = _RANDOM[3'h3][9];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        mulAddRecFNToRaw_postMul_io_roundingMode_pipe_b = _RANDOM[3'h3][12:10];	// src/main/scala/chisel3/util/Valid.scala:130:26
        roundingMode_stage0_pipe_v = _RANDOM[3'h3][13];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        roundingMode_stage0_pipe_b = _RANDOM[3'h3][16:14];	// src/main/scala/chisel3/util/Valid.scala:130:26
        detectTininess_stage0_pipe_v = _RANDOM[3'h3][17];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        valid_stage0_pipe_v = _RANDOM[3'h3][19];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        roundRawFNToRecFN_io_invalidExc_pipe_v = _RANDOM[3'h3][21];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        roundRawFNToRecFN_io_invalidExc_pipe_b = _RANDOM[3'h3][22];	// src/main/scala/chisel3/util/Valid.scala:130:26
        roundRawFNToRecFN_io_in_pipe_v = _RANDOM[3'h3][23];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        ...
        roundRawFNToRecFN_io_roundingMode_pipe_v = _RANDOM[3'h5][1];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        roundRawFNToRecFN_io_roundingMode_pipe_b = _RANDOM[3'h5][4:2];	// src/main/scala/chisel3/util/Valid.scala:130:26
        roundRawFNToRecFN_io_detectTininess_pipe_v = _RANDOM[3'h5][5];	// src/main/scala/chisel3/util/Valid.scala:129:24, :130:26
        roundRawFNToRecFN_io_detectTininess_pipe_b = _RANDOM[3'h5][6];	// src/main/scala/chisel3/util/Valid.scala:130:26
  ...
  MulAddRecFNToRaw_preMul mulAddRecFNToRaw_preMul (	// src/main/scala/tile/FPU.scala:646:41
    .io_op                        (io_op_0),
    .io_a                         (io_a_0),
    .io_b                         (io_b_0),
    .io_c                         (io_c_0),
  ...
  MulAddRecFNToRaw_postMul mulAddRecFNToRaw_postMul (	// src/main/scala/tile/FPU.scala:647:42
  ...
  RoundRawFNToRecFN roundRawFNToRecFN (	// src/main/scala/tile/FPU.scala:674:35
