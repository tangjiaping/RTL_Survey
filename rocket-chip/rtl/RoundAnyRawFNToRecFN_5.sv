...
module RoundAnyRawFNToRecFN_5(
      ...
      ? (roundMask_msb_1
           ...
           : {22'h0,
              roundMask_msb_3
                ...
                : 3'h0})
      : 25'h0;	// hardfloat/hardfloat/src/main/scala/primitives.scala:58:25, :62:24, :67:24, :68:58, :73:{17,21,32}, :76:56, :77:20, :78:22
  wire [26:0] roundMask =
  ...
  wire [25:0] roundedSig =
    roundIncr
      ...
      : {1'h0, adjustedSig[26:2] & ~(roundMask[26:2])}
        | (roundingMode_odd & anyRound ? roundPosMask[26:1] : 26'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:89:53, :94:53, :113:22, :158:42, :162:46, :163:56, :164:62, :165:36, :169:31, :172:16, :173:{32,49,57}, :174:{21,25,64}, :175:30, :176:35, :179:{30,32,43,47}, :180:{24,42,67}
  wire [10:0] sRoundedExp = {io_in_sExp_0[9], io_in_sExp_0} + {9'h0, roundedSig[25:24]};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:172:16, :184:{40,54}
  ...
  wire        common_underflow =
    ...
    & ~(~(doShiftSigDown1 ? roundMask[4] : roundMask[3]) & roundCarry & roundPosBit
        & unboundedRange_roundIncr);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:119:57, :124:37, :125:37, :158:42, :163:56, :165:36, :207:46, :210:16, :216:40, :219:{49,64}, :220:{30,57,71,76}, :221:27, :222:{34,39}, :223:49, :226:60
  ...
  wire [8:0]  expOut =
    ...
    | (isNaNOut ? 9'h1C0 : 9'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:121:31, :124:37, :234:34, :244:45, :245:39, :247:32, :252:{14,18,32}, :256:{14,18}, :260:{14,18}, :263:17, :264:{14,18}, :268:16, :272:16, :276:{16,73}, :277:16
  wire [22:0] fractOut =
    (isNaNOut | io_in_isZero_0 | common_totalUnderflow
       ? {isNaNOut, 22'h0}
       : common_fractOut) | {23{pegMaxFiniteMagOut}};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:122:31, :124:37, :234:34, :245:39, :279:{12,38}, :280:16, :282:11, :283:13
