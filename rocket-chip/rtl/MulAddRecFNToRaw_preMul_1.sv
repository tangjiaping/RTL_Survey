...
module MulAddRecFNToRaw_preMul_1(
  ...
  wire [53:0]  rawA_sig = {1'h0, ~rawA_isZero_0, io_a_0[51:0]};	// hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}
  ...
  wire [53:0]  rawB_sig = {1'h0, ~rawB_isZero_0, io_b_0[51:0]};	// hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}
  ...
  wire [12:0]  rawC_sExp = {1'h0, rawC_exp};	// hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:51:21, :55:23, :60:27
  wire [53:0]  rawC_sig = {1'h0, ~rawC_isZero_0, io_c_0[51:0]};	// hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}
