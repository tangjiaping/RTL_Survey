...
module DivSqrtRawFN_small(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic [4:0] _cycleNum_T_15;	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:311:15
      _cycleNum_T_15 =
      ...
      cycleNum <= {_cycleNum_T_15[4:1], _cycleNum_T_15[0] | skipCycle2};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:223:33, :300:63, :311:15, :312:95
      inReady <=
    ...
    if (entering | ~inReady) begin	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :296:28, :339:23, :389:20
      ...
      sigX_Z <=
        ...
        | (inReady ? 26'h0 : sigX_Z) | (~inReady & newBit ? bitMask[25:0] : 26'h0);	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :244:29, :339:23, :352:21, :359:34, :368:23, :393:{16,74}, :394:74, :395:{16,50}, :396:{16,74}, :397:{16,27}
    end
  end // always @(posedge)
