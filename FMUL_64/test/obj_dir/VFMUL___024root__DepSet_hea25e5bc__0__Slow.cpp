...
#endif
            VL_FATAL_MT("../rtl/FMUL.v", 149, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VFMUL___024root___ctor_var_reset(VFMUL___024root* vlSelf) {
    ...
    vlSelf->io_rm = VL_RAND_RESET_I(3);
    vlSelf->io_result = VL_RAND_RESET_Q(64);
    vlSelf->io_fflags = VL_RAND_RESET_I(5);
    vlSelf->io_to_fadd_fp_prod_sign = VL_RAND_RESET_I(1);
    vlSelf->io_to_fadd_fp_prod_exp = VL_RAND_RESET_I(11);
    VL_RAND_RESET_W(105, vlSelf->io_to_fadd_fp_prod_sig);
    vlSelf->io_to_fadd_inter_flags_isNaN = VL_RAND_RESET_I(1);
    vlSelf->io_to_fadd_inter_flags_isInf = VL_RAND_RESET_I(1);
    vlSelf->io_to_fadd_inter_flags_isInv = VL_RAND_RESET_I(1);
    vlSelf->io_to_fadd_inter_flags_overflow = VL_RAND_RESET_I(1);
}
